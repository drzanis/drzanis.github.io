...
### Conference Papers
- **Evaluating Pre-Trained Models for Multi-Language Vulnerability Patching**. <span style="color: blue; font-weight: bold; font-style: italic;">Zanis Ali Khan</span>, Aayush Garg, Yuejun Guo, Qiang Tang. ACM/SIGAPP Symposium on Applied Computing (SAC) Computer Security (SEC) 2026

- **Evaluating LLMs for One-Shot Patching of Real and Artificial Vulnerabilities.**. Aayush Garg, <span style="color: blue; font-weight: bold; font-style: italic;">Zanis Ali Khan</span>, Yuejun Guo, Qiang Tang. ACM/SIGAPP Symposium on Applied Computing (SAC) Computer Security (SEC) 2026
